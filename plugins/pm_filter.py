...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("ᴛʜɪs ᴍᴏᴠɪᴇ ɪs ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ ᴀɴᴏᴛʜᴇʀ ᴜsᴇʀ ❤️\n\nɪғ ʏᴏᴜ ɴᴇᴇᴅ ᴍᴏᴠɪᴇs ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ʀᴇǫᴜᴇsᴛ 😌🔥", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ ᴡᴏʀᴋɪɴɢ ɢʀᴏᴜᴘ ⚡', url='https://t.me/+HElRgfS043YwMmVl')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/ar_bots'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            fmsg = await message.reply_photo(photo=imdb.get('https://telegra.ph/file/cac48c3806cd3bbae08e0.jpg'), caption=cap[:1024],
                                      reply_markup=InlineKeyboardMarkup(btn))
